...
const ContactForm = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "flex flex-col sm:flex-row gap-4 items-center justify-items-center"
    ...
    className: "flex w-full flex-col sm:flex-row justify-center gap-4 items-center"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "w-full sm:w-1/2 flex flex-col sm:flex-row gap-4"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "number",
    name: "age",
    placeholder: "Age",
...
const Question = _ref => {
  ...
  const [multipleChoice, setMultipleChoice] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(data.multiple_answer);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    return data.question_type == "radio" ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
      key: index,
      ...
      required: true
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, option.option)) : data.question_type == "checkbox" ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
      key: index,
      className: "flex gap-2 items-center  cursor-pointer"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
      type: "checkbox",
    ...
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, option.option)) : null;
  })));
};
...
const Success = _ref => {
  ...
  const handleSendEmail = () => {
    ...
    const emailData = {
      to: email,
      subject: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Thanks for Completing the survey!", "gsurvey"),
      body: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Survey complete! Thank you for your time.", "gsurvey")
    };

    // Send the email

    axios__WEBPACK_IMPORTED_MODULE_5__["default"].post("/wp-json/gsurvey/v1/send-email", emailData).then(() => {
      setSubmitted(true);
  ...
  }, submitted ? "Survey complete! Thank you for your time." : "Almost There! Submit your Survey."), !submitted && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
...
/* harmony import */ var _components_Success__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Success */ "./src/components/Success.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  surveyDiv.forEach(function (div) {
    ...
    react_dom__WEBPACK_IMPORTED_MODULE_2___default().render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Survey, {
      data: data
    }), div);
...
const Survey = _ref => {
  ...
  const [totalSteps, setTotalSteps] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(Number(data.question_list.length) + 2);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "w-full bg-gray-500 rounded-full dark:bg-gray-700"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "survey_body py-4"
  }, steps === 1 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ContactForm__WEBPACK_IMPORTED_MODULE_4__["default"], {
    data: formData,
    onChange: updatePersonalInfo
  }), formData.questions.map((question, index) => {
    return steps === index + 2 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_Question__WEBPACK_IMPORTED_MODULE_6__["default"], {
      data: question,
      onChange: e => updateAnswer(e, index)
    });
  }), steps === totalSteps && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_Success__WEBPACK_IMPORTED_MODULE_5__["default"], {
    data: formData
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "survey_footer flex justify-center gap-2 p-5 bg-gray-200"
